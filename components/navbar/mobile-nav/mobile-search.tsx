...
export function MobileSearch({ onSubmit }: MobileSearchProps) {
  ...
  return (
    <form onSubmit={handleSearch} className="px-4 pt-4" role="search">
      ...
      <div className="relative">
        ...
        />
        <button type="submit" disabled={!query.trim()} aria-label="Search" className="absolute top-1/2 right-2 flex h-8 w-8 -translate-y-1/2 cursor-pointer items-center justify-center disabled:cursor-not-allowed disabled:opacity-40">
